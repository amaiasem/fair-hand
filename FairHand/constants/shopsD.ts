const shopsD = [
  ...
  {
    _id: 'asiuduhb87',
    shopName: 'InfinitDenim',
    address: 'Parlament, 25 08015 Barcelona',
    latlong: {
      lat: 41.376440,
      long: 2.162350
    },
    schedule: 'Monday to Saturday 11h - 21h / Monday to Saturday 11h - 21h',
    website: 'https://bravafabrics.com/',
    phone: 931277197,
    coverImage: 'https://cdn.shopify.com/s/files/1/0043/0804/1831/files/cartela-web-EN_fdb23f61-d5dc-49e0-98f3-71fdb8298b3e_2000x.jpg?v=1614686668',
    logoImage: 'https://www.infinitdenim.com/wp-content/uploads/2020/05/logo.png',
    type: ['clothes'],
    NewIn: [
      {
        productName: 'INKA GOLD PANTS',
